...
class CatVideoPlayerState extends VideoPlayerStatefulWidgetState {
  ...
  void initState() {
    super.initState();
    videoPlayerController1 = VideoPlayerController.asset('assets/videos/Anixouscat.mp4');
  ...
  Widget createCustomDynamicHorizontalImageScroller() {
    switch (selectedVideoType) {
      case videotypes.GeneralHealth:
        {
          developer.log('number of ' +
              selectedVideoType.toString() +
              ' videos: ' +
              util.generalhealthcatvideos.length.toString());
          return createDynamicHorizontalImageScroller(util.generalhealthcatvideos);
        }
        break;
      case videotypes.CareTips:
        {
          developer.log('number of ' +
              selectedVideoType.toString() +
              ' videos: ' +
              util.catcaretips.length.toString());
          return createDynamicHorizontalImageScroller(util.catcaretips);
        }
        break;
      case videotypes.HelpfulInfo:
        {
          developer.log('number of ' +
              selectedVideoType.toString() +
              ' videos: ' +
              util.cathelpfulinfo.length.toString());
          return createDynamicHorizontalImageScroller(util.cathelpfulinfo);
        }
        break;
      case videotypes.Nutrition:
        {
          developer.log('number of ' +
              selectedVideoType.toString() +
              ' videos: ' +
              util.catnutritionalinfo.length.toString());
          return createDynamicHorizontalImageScroller(util.catnutritionalinfo);
        }
        break;
      default:
        break;
...
//  PawsVideo('Checking for Fleas', 'assets/videos/Cat/caretips/Checkforfleas.mp4',
...
//  PawsVideo('Cat Constipation', 'assets/videos/Cat/generalhealth/CatConstipation.mp4',
...
//  PawsVideo('Kitten Health Problems', 'assets/videos/Cat/generalhealth/KittenHealthProblems.mp4',
//      'assets/videos/Cat/generalhealth/generalhealththumbnails/Healthproblems.JPG'),
//  PawsVideo('When to Neuter', 'assets/videos/Cat/generalhealth/WhenNeuterCat.mp4',
...
//  PawsVideo('How to Pickup a Cat', 'assets/videos/Cat/helpfulinfo/Pickupcat.mp4',
...
//  PawsVideo('Stop Cat Climbing on Furniture', 'assets/videos/Cat/helpfulinfo/Stopcatfurniture.mp4',
//      'assets/videos/Cat/helpfulinfo/cathelpfulinfothumbnails/climbing.JPG'),
//  PawsVideo('How to Travel With a Cat', 'assets/videos/Cat/helpfulinfo/Travelwithcat.mp4',
//      'assets/videos/Cat/helpfulinfo/cathelpfulinfothumbnails/Traveling.JPG'),
//];
//
//final List<PawsVideo> _nutritionalinfoVideos = [
//  PawsVideo('3 Foods to Never Feed Your Cat', 'assets/videos/Cat/nutritionalinfo/3foodsnever.mp4',
...
//  PawsVideo('What If Cat Eats Dog Food', 'assets/videos/Cat/nutritionalinfo/Catdogfood.mp4',
...
//  PawsVideo('Cat Not Eating', 'assets/videos/Cat/nutritionalinfo/Catnoteating.mp4',
//      'assets/videos/Cat/nutritionalinfo/catnutritionalinfothumbnails/noteating.JPG'),
//  PawsVideo('Healthy Fruit for Cat', 'assets/videos/Cat/nutritionalinfo/Healthyfruitcat.mp4',
